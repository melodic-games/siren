...
Shader "Sand Terrain"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float3 lerpResult3_g248 = lerp( normalizeResult5_g258 , normalizeResult9_g249 , ( _GrainStrength * ( 1.0 - pow( ( ( distance( _WorldSpaceCameraPos , ase_worldPos ) - temp_output_1_0_g247 ) / ( _GrainFalloffDistance - temp_output_1_0_g247 ) ) , _GrainFalloffPower ) ) ));
			...
			float4 break21_g260 = tex2D( _GlitterNoiseTexture, ( i.uv_texcoord * _GlitterSize ) );
			float3 appendResult22_g260 = (float3(break21_g260.r , break21_g260.g , break21_g260.b));
			float3 temp_cast_2 = (1.0).xxx;
			float3 normalizeResult38_g260 = normalize( ( ( appendResult22_g260 * 2.0 ) - temp_cast_2 ) );
			float dotResult5_g260 = dot( reflect( ase_worldlightDir , normalizeResult38_g260 ) , ase_worldViewDir );
			float smoothstepResult33_g260 = smoothstep( _GlitterThreshold , ( _GlitterThreshold + _GlitterFade ) , saturate( dotResult5_g260 ));
			float4 Specular176 = ( saturate( ( max( ( fresnelNode15_g241 * _RimColor ) , ( ( pow( saturate( dotResult6_g250 ) , _OceanSpecularPower ) * _OceanSpecularStrength ) * _OceanSpecularColor ) ) + ( _GliterColor * smoothstepResult33_g260 ) ) ) * LightData172 );
...
/*ASEBEGIN
Version=19002
589;911;1524;488;2989.358;-180.7006;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;243;-2616.596,373.9987;Inherit;False;Sand Terrain Ripples Normal;0;;256;6ed8ef22b18433949a2efc526b57ab12;0;1;18;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;244;-2547.884,1425.158;Inherit;False;Sand Terrain Glitter Specular;6;;260;d5878071f536945bea46797893d17372;0;0;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;95;-222.5822,1168.47;Inherit;False;Property;_ColorTerrain;Color Terrain;12;0;Create;True;0;0;0;False;0;False;0.9137255,0.5450981,0.5254902,0;0.6666667,0.3788886,0.1999997,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=82069EDB18C5E008D196C217642E3B21AF9DACBC