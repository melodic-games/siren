...
Shader "Sand Terrain"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 Specular176 = ( saturate( ( max( ( fresnelNode15_g241 * _RimColor ) , ( ( pow( saturate( dotResult6_g250 ) , _OceanSpecularPower ) * _OceanSpecularStrength ) * _OceanSpecularColor ) ) + ( _GliterColor * smoothstepResult33_g251 ) ) ) * LightData172 );
...
Node;AmplifyShaderEditor.CommentaryNode;93;-3009.872,1171.915;Inherit;False;1604.153;347.3696;;10;176;178;92;177;230;238;182;91;151;171;Specular;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;238;-2547.884,1425.158;Inherit;False;Sand Terrain Glitter Specular;6;;251;d5878071f536945bea46797893d17372;0;0;1;COLOR;0
